...
def main(page: ft.Page):
    # 📱 1. 基礎設定
    page.title = "智慧巡檢 App V5.0 - 完美非同步版"
    ...
    # 🔥🔥🔥 終極修復：這裡加上了 async 與 await，讓程式乖乖等待相機開啟！
    ...
    camera_view_box = ft.Container(
        ...
        content=ft.Container(
            ...
            border=ft.Border(
                top=ft.BorderSide(2, "white"), 
                right=ft.BorderSide(2, "white"), 
                bottom=ft.BorderSide(2, "white"), 
                left=ft.BorderSide(2, "white")
            ),
    ...
    # 改回使用 Container，避開終端機裡的 ElevatedButton 淘汰警告
    ...
    def create_preview_box(idx, title):
        box_content = ft.Image(src=captured_photos[idx-1], fit=ft.ImageFit.COVER) if captured_photos[idx-1] != "" else ft.Text(title, text_align="center", color="black")
        return ft.Container(
