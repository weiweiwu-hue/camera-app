...
def main(page: ft.Page):
    # 📱 1. 基礎設定
    page.title = "智慧巡檢 App V1.7 - 終極大決戰版"
    ...
    try:
        ...
        camera_view_box = ft.Container(
            ...
            content=ft.Container(
                ...
                content=ft.Text("📷\n請點擊下方按鈕啟動相機", color="white", size=14, text_align="center")
            )
        )
        ...
        # ==========================================
        # 🚀 終極殺招：徹底放棄 buggy 的 overlay 背景層！
        # ==========================================
        # 我們直接把 file_picker 當作一個隱形的 UI 元件，強制塞進主畫面上！
        page.add(file_picker, root_view) 
        switch_to_camera()
