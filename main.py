...
def main(page: ft.Page):
    page.title = "智慧巡檢 App V1.8 - 權限破關版"
    ...
    try:
        ...
        info_text = ft.Text(value="", size=16, weight="bold", color="blue", text_align="center")
        ...
        file_picker.on_result = on_photo_picked  # 第一步：先綁定動作
        page.overlay.append(file_picker)         # 第二步：放入背景層
        page.update()                            # 第三步：立刻存檔告訴手機！
        ...
        camera_view_box = ft.Container(
            ...
            content=ft.Container(
                ...
                content=ft.Text("📷\n請點擊下方按鈕啟動相簿 / 相機", color="white", size=14, text_align="center")
            )
        )
        ...
        def create_preview_box(idx, title):
            ...
            return ft.Container(
                content=box_content, bgcolor="#e1e1e1", expand=1, height=140, border_radius=5, alignment=ft.Alignment(0, 0), 
        ...
        page.add(ft.Text(f"【請截圖】App 崩潰日誌：\n{error_msg}", color="red", size=14, selectable=True))
        page.update()
