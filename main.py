...
def main(page: ft.Page):
    # 📱 1. 基本設定
    page.title = "智慧巡檢 App V1.5.1 - 終極防護版"
    ...
    try:
        ...
        # 🚀 無敵排版術：用一個透明的隱形方塊，物理性地把畫面往下推 40 像素避開瀏海！
